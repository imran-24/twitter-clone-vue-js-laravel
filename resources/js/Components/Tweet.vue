<template>
    ...
    <div class="min-w-[60px] pt-2">
        <img class="rounded-full m-2 mt-3 h-10 w-10"  :src="tweet.image">
    </div>
                ...
                <div v-if="openOptions" class="absolute mt-1 right-0 w-[300px] bg-black border border-gray-700 rounded-lg shadow-lg">
                    <ul class="">
                        <Link
                            ...
                            class="flex items-center cursor-pointer hover:bg-neutral-950 w-full p-3 rounded-lg shadow-lg"
                        >
