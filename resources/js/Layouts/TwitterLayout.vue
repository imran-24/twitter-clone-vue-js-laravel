...
<template>
    <div class="fixed w-full">
        ...
        <div class="max-w-[1400px] flex justify-center mx-auto ">
            
            <!-- sidebar start -->
            <div class="lg:w-3/12 w-[60px] h-[100vh] max-w-[400px] lg:px-4 ">
                ...
                <!-- </Link> -->
                <Link method="POST" :href="route('logout')" class=" w-full">
                    <MenuItem iconString="Logout" />
                </Link>
                ...
                <button
                    ...
                    class="lg:w-full mt-8 ml-2 text-white font-extrabold text-[18px] bg-[#1C9CEF] p-3 px-3 rounded-full cursor-pointer"
                >
            ...
            <!-- start main body -->
            <div class="lg:w-5/12 w-11/12 border-x border-gray-800 relative">
                <div class=" bg-black bg-opacity-50 backdrop-blur-md z-10 absolute w-full">
                    <div class="border-gray-800 border-b w-full">
                        <div class="w-full text-white text-[20px] font-extrabold p-4">
                            Home
                        </div>
                        <div class="flex">
                            <div
                                class="flex items-center justify-center w-full h-[60px] text-white text-[16px] font-extrabold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out">
                                <div class="inline-block text-center border-b-4 border-b-[#1C9CEF] h-[60px]">
                                    <div class="my-auto mt-4">For you </div>
                                </div>
                            </div>
                            <div
                                class="w-full h-[60px] text-gray-500 text-[16px] font-extrabold p-4 hover:bg-gray-500 hover:bg-opacity-30 cursor-pointer transition duration-200 ease-in-out">
            ...
            <!-- start suggestion bar -->

            <div class="lg:block hidden lg:w-3/12 h-screen border-l border-gray-800 pl-4">
                    ...
                    <div class="h-[80px] hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between h-[80px] py-3">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold mb-6 text-[16px]">Australian Open 2023</div>
                            </div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[16px]">Doomsday Clock</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[16px]">Poro</div>
                    ...
                    <div class="hover:bg-gray-800 cursor-pointer transition duration-200 ease-in-out">
                        <div class="flex p-3 justify-between">
                            <div>
                                ...
                                <div class="w-full text-white font-extrabold text-[16px]">Sunak</div>
    ...
    <!-- modal -->
    <div v-if="createTweet" class="fixed top-0 left-0 w-full h-screen bg-black md:bg-gray-400 md:bg-opacity-30 overflow-y-scroll"> 
        <div class="md:max-w-2xl md:m-auto md:mt-10 md:rounded-lg bg-black">
            ...
            <div class="flex items-center justify-between md:inline-block p-2 m-2 rounded-full cursor-pointer">
                ...
                <div  class="hover:bg-gray-800 inline-block p-2 rounded-full cursor-pointer">
                    <Close @click="closeMessageBox()" fillColor="#FFFFFF" :size="28" class="md:block hidden"/>
            ...
            <div class="w-full flex ">
                ...
                <div class="ml-3.5 mr-2">
                    <img class="rounded-full" width="55"  :src="user.image" />
                </div>
